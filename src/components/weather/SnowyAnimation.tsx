      ...
      {flakes.map((flake, i) => (
        ...
        >
          <svg
            ...
            fill="none"
          >
            <circle cx="8" cy="8" r="6" fill="white" opacity={flake.opacity} />
            <line x1="8" y1="1" x2="8" y2="15" stroke="white" strokeWidth="0.5" opacity={flake.opacity * 0.7} />
            <line x1="1" y1="8" x2="15" y2="8" stroke="white" strokeWidth="0.5" opacity={flake.opacity * 0.7} />
            <line x1="3" y1="3" x2="13" y2="13" stroke="white" strokeWidth="0.5" opacity={flake.opacity * 0.7} />
            <line x1="13" y1="3" x2="3" y2="13" stroke="white" strokeWidth="0.5" opacity={flake.opacity * 0.7} />
          </svg>
        </div>
      ))}
    </div>
