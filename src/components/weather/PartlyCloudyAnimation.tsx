  ...
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{
          ["--cloud-duration" as string]: "30s",
          ["--cloud-delay" as string]: "-10s",
        }}
      >
        <svg width="180" height="90" viewBox="0 0 120 60" fill="none">
          <ellipse cx="60" cy="40" rx="50" ry="18" fill="white" opacity="0.95" />
          <ellipse cx="40" cy="30" rx="28" ry="22" fill="white" />
          <ellipse cx="75" cy="28" rx="24" ry="20" fill="white" opacity="0.95" />
      ...
      <div
        ...
        style={{
          ["--cloud-duration" as string]: "25s",
          ["--cloud-delay" as string]: "-18s",
        }}
      >
        <svg width="100" height="50" viewBox="0 0 120 60" fill="none">
          <ellipse cx="60" cy="40" rx="50" ry="18" fill="white" opacity="0.7" />
          <ellipse cx="45" cy="30" rx="25" ry="18" fill="white" opacity="0.75" />
        </svg>
      </div>
    </div>
  );
