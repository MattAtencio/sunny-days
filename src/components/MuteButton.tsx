...
export default function MuteButton() {
  ...
  return (
    <button
      onClick={toggle}
      className="fixed top-4 right-4 z-50 w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm shadow-lg flex items-center justify-center text-2xl active:scale-90 transition-transform"
