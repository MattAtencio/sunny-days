    ...
    >
      ...
      >
        ...
        {accessory === "scarf" && (
          <g>
            <path
              d="M40 90 Q55 98 80 96 Q105 94 115 88"
              stroke="#ef4444"
              strokeWidth="6"
              strokeLinecap="round"
              fill="none"
        ...
        {accessory === "raincoat" && (
          <g>
            <path
              d="M30 85 Q35 100 45 108 L115 108 Q125 100 130 85"
              fill="#fbbf24"
              opacity="0.8"
            />
            <path
              d="M30 85 Q35 88 80 90 Q125 88 130 85"
              fill="#f59e0b"
              opacity="0.6"
            />
          </g>
        ...
        {accessory === "earmuffs" && (
          <g>
            <path
              d="M35 55 Q38 35 73 33 Q108 35 115 55"
              stroke="#a855f7"
              strokeWidth="3"
              fill="none"
            />
        ...
        {accessory === "kite" && (
          <g transform="translate(115, 15)">
            ...
            <polygon
              points="15,0 25,15 15,15"
              fill="#ec4899"
              opacity="0.5"
            />
            {/* Tail */}
            <path
              d="M15 30 Q20 38 12 42 Q18 48 14 54"
              stroke="#f472b6"
              strokeWidth="1.5"
              fill="none"
            />
